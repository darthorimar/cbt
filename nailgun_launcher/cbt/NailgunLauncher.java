  ...
  public static BuildStage1Result buildStage1(
    ...
    if(!compatibilityTarget.startsWith(cbtHome)){
      ...
      for( String d: new String[]{
        ...
        cbtHome + "/libraries/interfaces/cbt/interfaces"
      } ){
    ...
    for( String d: new String[]{
      ...
      cbtHome + "/libraries/common-1/cbt",
